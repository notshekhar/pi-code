---
name: release
description: "Run the Pi Code release workflow — review staged diff, bump version, commit, tag, push, and create a GitHub release. Use when releasing, bumping version, tagging, or creating a release. Argument: major, minor, or patch."
---

# Pi Code Release Workflow
