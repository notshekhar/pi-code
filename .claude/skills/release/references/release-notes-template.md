# Pi Code Release Notes Template
...
**Full Changelog**: https://github.com/notshekhar/pi-code/compare/v{prev}...v{current}
```
...
You can now use `@#foldername` in the composer to include the full contents of a folder — not just the file tree, but every file inside it. Regular `@folder` still gives you the structure overview. If the folder is large, Pi Code will warn you before sending.
...
**Full Changelog**: https://github.com/notshekhar/pi-code/compare/v0.20.0...v0.21.0
```
...
**Full Changelog**: https://github.com/notshekhar/pi-code/compare/v0.21.0...v0.21.1
```
