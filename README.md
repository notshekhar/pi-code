> [!WARNING]
> Pi Code is in early development and issues are to be expected. Please feel free to report bugs and issues in the Issues section.
...
<p align="center">
  <a href="https://github.com/notshekhar/pi-code/releases"><img alt="Latest Release" src="https://img.shields.io/github/v/release/notshekhar/pi-code?style=flat-square&color=blue" /></a>
  <a href="https://github.com/notshekhar/pi-code/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/notshekhar/pi-code?style=flat-square" /></a>
  ...
  <img alt="License" src="https://img.shields.io/github/license/notshekhar/pi-code?style=flat-square" />
  <a href="https://github.com/notshekhar/pi-code/actions"><img alt="Build" src="https://img.shields.io/github/actions/workflow/status/notshekhar/pi-code/build.yml?style=flat-square&label=build" /></a>
</p>

---

Pi Code is a cross-platform desktop app that gives you one interface to run, manage, and switch between AI coding agents — Claude Code, Codex, and any ACP-compatible agent — without losing context, sessions, or tool state.
...
1. **Download** the latest release for your platform from the [Releases page](https://github.com/notshekhar/pi-code/releases/latest)
2. **Open a project** — point Pi Code at any folder on disk
...
Pi Code supports three execution engines out of the box:
...
| Platform | Download |
|----------|----------|
| macOS (Apple Silicon) | [`.dmg` (arm64)](https://github.com/notshekhar/pi-code/releases/latest) |
| macOS (Intel) | [`.dmg` (x64)](https://github.com/notshekhar/pi-code/releases/latest) |
| Windows (x64) | [`.exe` installer](https://github.com/notshekhar/pi-code/releases/latest) |
| Windows (ARM64) | [`.exe` installer](https://github.com/notshekhar/pi-code/releases/latest) |
| Linux | [`.AppImage`](https://github.com/notshekhar/pi-code/releases/latest) / [`.deb`](https://github.com/notshekhar/pi-code/releases/latest) |
