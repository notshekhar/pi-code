...
import type {
  ...
  GitRepoInfo, GitStatus, GitBranch, GitLogEntry, GitFileGroup,
  ...
  interface Window {
    claude: {
      ...
      git: {
        ...
        diffFile: (cwd: string, file: string, staged: boolean, group?: GitFileGroup) => Promise<{ diff?: string; error?: string }>;
