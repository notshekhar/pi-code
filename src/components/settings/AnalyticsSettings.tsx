    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-foreground/[0.06] px-6 py-4">
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">
          Help improve Pi Code by sharing anonymous usage data
        </p>
      </div>
        ...
        <div className="px-6 py-2">
          ...
          <div className="py-3">
            ...
            <SettingRow
              ...
              description="Share anonymous usage data to help us understand how people use Pi Code and improve the app. We collect app version, platform, and basic feature usage. No code, prompts, or personal data is collected."
            >
              <Switch
