...
export const AdvancedSettings = memo(function AdvancedSettings({
  ...
  const [codexClientName, setCodexClientName] = useState("Pi Code");
  ...
  useEffect(() => {
    if (appSettings) {
      setCodexClientName(appSettings.codexClientName || "Pi Code");
          ...
          {section === "engines" && (
            <div className="py-3">
              ...
              <SettingRow
                ...
                description="Choose how Pi Code resolves the Claude executable."
              >
                <SettingsSelect
          ...
          <div className="py-3">
            ...
            {section === "engines" && (
              <SettingRow
                ...
                description="Choose how Pi Code resolves the Codex executable."
              >
                <SettingsSelect
